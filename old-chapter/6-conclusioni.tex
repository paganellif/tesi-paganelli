...
% dire i risultati ottenuti come ad esempio tempistiche delle pipeline per i vari casi (con cache locale, con cache shared, modifica solo al codice shared, solo alla app android o tutto, ...), cosa non è stato fatto e le grosse difficoltà di integrazione xcode-ios-kmm oltre al problema coroutine
