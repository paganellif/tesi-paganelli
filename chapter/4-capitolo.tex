...
%espresso (android) + questione screenshot (screengrab android e snapshot ios)
...
\begin{itemize}
    ...
    \item \textit{Snapshot}\footnote{\url{https://docs.fastlane.tools/actions/snapshot/}} (iOS) -
\end{itemize}
