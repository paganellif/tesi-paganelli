...
Tipicamente sistemi di questo tipo, per poter modificare il codice in modo automatico, vengono integrati con le piattaforme utilizzate per il versionamento del codice, come GitLab nel caso di questo progetto di tesi. L'aggiornamento delle dipendenze automatizzato deve essere gestito come una modifica al codice esterna che deve essere approvata da uno o più membri del team e testata prima di poter essere applicata al flusso principale di sviluppo. Per questo scopo vengono utilizzate le stesse tecniche e gli stessi tools di continuous integration adottati nel processo di sviluppo.
