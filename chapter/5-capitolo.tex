...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{img/tesi-14-mockup1.drawio.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{img/tesi-23-mockupv2.drawio.png}
...
\caption{Diagramma delle classi: Implementazioni data source (persistenza dati e networking)}
\end{figure}
...
L'applicazione sviluppata per la piattaforma Android implementa sia lo strato di presentazione dei dati utilizzando la business logic fornita dal modulo \textit{Shared} che la logica del visualizzatore dei contenuti digitali tramite il toolkit Kotlin della libreria \textit{Readium}.\\
