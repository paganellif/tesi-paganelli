...
\begin{itemize}
    ...
    \item \textit{podspec} - Genera il file \textit{podspec}, utile all'importazione del pod nella applicazione iOS.
\end{itemize}

A questo punto è possibile importare il modulo shared nel codice Swift e sviluppare l'applicazione utilizzando le funzionalità fornite dall'IDE a supporto dello sviluppo come per una qualsiasi libreria Swift.