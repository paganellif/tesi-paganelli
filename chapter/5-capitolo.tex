...
L'obiettivo principale della applicazione è quello di permettere all'utente di "sfogliare" i contenuti digitali pubblicati da Maggioli Editore sul proprio dispositivo. In questo caso si identificano quindi tre contesti:
...
% descrivere la fase di rilascio nei vari casi alpha, beta con screenshot google play console + testflight
