...
ho dovuto fare extension per la gestione delle date (millisecondsSince1970)
...
\begin{comment}
            \begin{figure}[H]
                \includegraphics[width=0.21\textwidth]{img/annotations_ios.png}
                \caption{Esempio di inserimento di annotazioni come evidenziazioni e sottolineature}
                \label{annotationsios}
            \end{figure}

            \begin{figure}[H]
                \includegraphics[width=0.21\textwidth]{img/annotation2_ios.png}
                \caption{Annotazioni memorizzate sul dispositivo e consultabili dal menu del lettore}
                \label{annotation2ios}
            \end{figure}
\end{comment}
